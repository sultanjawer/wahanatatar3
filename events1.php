							...
							<div class="col">
								<div class="card h-100 border-0 shadow">
									<div id="event-date" class="event-date">
										<div class="row">
											<span class="fw-bold" style="font-size:28px; font-weight:900; ">23</span>
											<span class="" style="font-size:14px;">Aug</span>
										</div>
									</div>
									<img src="assets/img/default_large.png" class="card-img-top" alt="...">
									<div class="card-body">
										<div class="d-flex justify-content-between align-items-center">
											<h5 class="card-title">
												<a href="eventsdetail/event-single.php">Card title</a>
											</h5>
										...
										<span class="card-text d-flex justify-content-between mb-3">
											<small class="text-body-secondary">
												...
												<span class="text-primary">Aug 23, 2023</span> |
												<!-- venue -->
												<i class="fa fa-map-marker-alt mr-1"></i>
												<span class="text-primary">Royal Palace</span>
											</small>
										</span>
							...
							<div class="sidebar-item recent-posts">
								...
								<div class="mt-3">
									<div class="post-item mt-3">
										...
										<div>
											<h4><a href="eventsdetail/event-single.php">Nihil blanditiis at in nihil autem</a></h4>
									...
									<div class="post-item">
										...
										<div>
											<h4><a href="eventsdetail/event-single.php">Quidem autem et impedit</a></h4>
											<time datetime="2020-01-01">Jan 1, 2020</time>
										</div>
									</div><!-- End recent post item-->
									...
									<div class="post-item">
										...
										<div>
											<h4><a href="eventsdetail/event-single.php">Id quia et et ut maxime similique occaecati ut</a></h4>
											<time datetime="2020-01-01">Jan 1, 2020</time>
										</div>
									</div><!-- End recent post item-->
									...
									<div class="post-item">
										...
										<div>
											<h4><a href="eventsdetail/event-single.php">Laborum corporis quo dara net para</a></h4>
											<time datetime="2020-01-01">Jan 1, 2020</time>
										</div>
									</div><!-- End recent post item-->
									<div class="post-item">
										...
										<div>
											<h4><a href="eventsdetail/event-single.php">Et dolores corrupti quae illo quod dolor</a></h4>
											<time datetime="2020-01-01">Jan 1, 2020</time>
										</div>
									</div><!-- End recent post item-->
								</div>
				...
				<div class="p-3 bg-body rounded shadow" data-aos="fade-up">
					...
					<div class="d-flex text-body-secondary pt-3">
						...
						<p class="pb-3 mb-0 small lh-sm border-bottom">
							<a href="eventsdetail/event-single.php">
