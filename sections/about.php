	...
	<div class="container text-white">
		...
		<div class="row row-cols-1 row-cols-md-2 align-items-md-center g-5">
			<div class="col-md-5 d-flex flex-column align-items-start gap-2">
				...
				<a href="index.php#contact" class="btn btn-warning btn-sm scrollto">Contact Us</a>
			</div>
					...
					<div class="col">
						<div class="d-flex flex-column h-100">
							...
							<div class="mt-auto text-center">
								<a href="about/board-of-directors.php" class="btn btn-info btn-sm">Learn More</a>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="d-flex flex-column h-100">
							...
							<div class="mt-auto text-center">
								<a href="about/vision-mission.php" class="btn btn-info btn-sm">Learn More</a>
							</div>
						</div>
					</div>
					<div class="col">
						<div class="d-flex flex-column h-100">
							...
							<div class="mt-auto text-center">
								<a href="about/proven-methodology.php" class="btn btn-info btn-sm">Learn More</a>
							</div>
						</div>
					</div>
				</div>
