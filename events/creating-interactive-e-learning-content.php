						...
						<article class="blog-details">
							<div class="post-img portfolio-details-slider swiper">
								<div class="swiper-wrapper align-items-center" style="max-height: 450px;">
										...
										<img src="/assets/img/events/slider/p3KXqmgqIBHx6SKKt4Q5i2zEOcK4EApTdjlehdJ6.jpg" alt="">
									</div>
																		<div class="swiper-slide">
										<img src="/assets/img/events/slider/wjem7kyvYHRBagLNsXpmYKwro3uTHCvv6R2GLzLG.jpg" alt="">
									</div>
																		<div class="swiper-slide">
										<img src="/assets/img/events/slider/sKpqttZgEpVQkMWO0OoyrFxlvZ1YjQbPE4wqPp6e.jpg" alt="">
									</div>
																	</div>
							...
							<div class="meta-top">
								<ul>
									...
									<li class="d-flex align-items-center"><i class="bi bi-calendar"></i> <time datetime="2023-08-31">Aug 31, 2023</time></a></li>
								</ul>
							</div><!-- End meta top -->
									...
									<div class="row no-gutters row-grid">
										<div class="col-12">
											<div class="d-flex flex-column align-items-center justify-content-center p-4 border-bottom">
												<img src="/assets/img/events/nlPrCc7Nh8uYmSCBP8EfeWDhzdAGGSQqaYuYPGpi.png" class="author img-fluid rounded-circle shadow-2 img-thumbnail" alt="">
